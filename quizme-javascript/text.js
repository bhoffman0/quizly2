...
Blockly.JavaScript.text_endString = function() {
  ...
  var first = this.getFieldValue('END') == 'FIRST';
  var code;
...
Blockly.JavaScript.text_changeCase = function() {
  ...
  if (operator) {
    ...
    if (!Blockly.JavaScript.definitions_['text_toTitleCase']) {
      ...
      var functionName = Blockly.JavaScript.nameDB_.getDistinctName(
...
Blockly.JavaScript.text_prompt = function() {
  // Prompt function.
  var msg = Blockly.JavaScript.quote_(this.getFieldValue('TEXT'));
