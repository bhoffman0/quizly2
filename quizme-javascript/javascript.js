 ...
 * Initialise the database of variable names.
 */
Blockly.JavaScript.init = function(workspace) { // Add 'workspace' parameter here
  ...
  if (Blockly.Variables) {
    ...
    // FIX: Add this line to resolve the "getName" deprecation error
    Blockly.JavaScript.nameDB_.setVariableMap(workspace.getVariableMap());

    var defvars = [];
    var variables = Blockly.Variables.allVariables(workspace); // Pass workspace here
    for (var x = 0; x < variables.length; x++) {
      defvars[x] = 'var ' +
          Blockly.JavaScript.nameDB_.getName(variables[x],
          'VARIABLE') + ';';
    }
