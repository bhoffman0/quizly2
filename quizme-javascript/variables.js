...
Blockly.JavaScript.lexical_variable_get = function() {
  // Variable getter.
  var code = Blockly.JavaScript.nameDB_.getName(this.getFieldValue('VAR'),
      'VARIABLE'); // Changed from Blockly.Variables.NAME_TYPE
...
Blockly.JavaScript.local_variable = function(block, isExpression) {
  ...
  for (i = 0; block.getFieldValue('VAR' + i); i++) {
    args.push(block.getFieldValue("VAR" + i));
