 ...
 *     Blockly.Xml.domToText(Blockly.Xml.workspaceToDom(Blockly.common.getMainWorkspace()))
...
function saveSolutionWorkspace() {
  var blks = Blockly.common.getMainWorkspace().getTopBlocks();
  if (blks.length != 0) {
    Blockly.Quizmaker.solutionWorkspace = Blockly.Xml.domToText(Blockly.Xml.workspaceToDom(Blockly.common.getMainWorkspace()));
    Blockly.Quizmaker.solutionBlocks = Blockly.common.getMainWorkspace().getTopBlocks();
  }
}
...
function saveProblemWorkspace() {
  var blks = Blockly.common.getMainWorkspace().getTopBlocks();
  if (blks.length != 0) {
    Blockly.Quizmaker.problemWorkspace = Blockly.Xml.domToText(Blockly.Xml.workspaceToDom(Blockly.common.getMainWorkspace()));
  }
}
...
function setMainWorkspaceFromText(txt) {
  Blockly.Xml.domToWorkspace(Blockly.common.getMainWorkspace(), Blockly.Xml.textToDom( txt ));
}
...
function evalMainWorkspace() {
  return Blockly.Quizme.eval(Blockly.common.getMainWorkspace().getTopBlocks()[0]);
}
